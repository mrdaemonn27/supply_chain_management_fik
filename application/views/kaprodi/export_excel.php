    ...
    <table>
        ...
        <?php foreach($pengajuan->items as $i => $item): ?>
            ...
            <tr>
                ...
                <td class="right"><?= excel_rp($jumlah_markup) ?></td>
        ...
        <?php endforeach; ?>
        <tr><td colspan="6" class="right bold">Sub Total (+20%)</td><td class="right bold"><?= excel_rp($pengajuan->summary['subtotal_markup']) ?></td><td></td><td colspan="3" class="right bold">Sub Total</td><td class="right bold"><?= excel_rp($pengajuan->summary['subtotal_negosiasi']) ?></td><td colspan="2"></td></tr>
        <tr><td colspan="6" class="right bold">PPN 11%</td><td class="right bold"><?= excel_rp($pengajuan->summary['ppn_penawaran']) ?></td><td></td><td colspan="3" class="right bold">PPN 11%</td><td class="right bold"><?= excel_rp($pengajuan->summary['ppn_negosiasi']) ?></td><td colspan="2"></td></tr>
        <tr><td colspan="6" class="right bold">Total</td><td class="right bold"><?= excel_rp($pengajuan->summary['total_penawaran']) ?></td><td></td><td colspan="3" class="right bold">Total</td><td class="right bold"><?= excel_rp($pengajuan->summary['total_negosiasi']) ?></td><td colspan="2"></td></tr>
        <tr><td colspan="14" class="no-border"></td></tr>
