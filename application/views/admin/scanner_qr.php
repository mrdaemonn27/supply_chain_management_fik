...
<body>
    <header class="topbar sticky-top">
        <div class="container-fluid px-3 px-lg-4 py-3 d-flex justify-content-between align-items-center gap-2">
            <div><div class="fw-bold"><i class="bi bi-qr-code-scan me-2 text-warning"></i>Scanner QR Serah Terima</div><div class="small text-white-50">Scan QR dari akun peminjam</div></div>
    ...
    <main class="container py-4">
        ...
        <section class="panel-card p-3 p-lg-4 text-center">
            ...
            <p class="text-muted small mb-3">Setelah QR terbaca, sistem langsung membuka halaman serah terima.</p>
            <div id="reader"></div>
